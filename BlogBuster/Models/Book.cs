...
namespace BlogBuster.Models
{
    public class Book
    {
        ...
        public Book(string Title, string Description, int User_Id)
        {
            this.Title = Title;
        ...
        public Book(int Id, string Title, string Description, int User_Id)
        {
            this.Id = Id;
            this.Title = Title;
            this.Description = Description;
        ...
        public bool Delete()
        {
            try
            {
                SqlConnectionGenerator.ExecuteStoreProcedure("sp_delete_book",
                    new string[] { "@Book_Id" },
                    new object[] { this.Id }
                    );
                return true;
